...
static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |                    PLayPause                              | |               |
     * |-----------------------------------------------------------| |---------------|
     * |Esc|  1|  2|  3|  4|  5|  6|  7|  8|  9|  0|  -|  =|Backsp | |FN0| = | / |PP |
     * |-----------------------------------------------------------| |---------------|
     * |Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|     | |Hom| 8 |PgU|V+ |
     * |-----------------------------------------------------'     | |---------------|
     * |Contro|  A|  S|  D|  F|  G|  H|  J|  K|  L|Fn3|  '|Return  | |End|Up |PgD|V- |
     * |-----------------------------------------------------------| |---------------|
     * |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|   /   |Shift | |Lf |Dn |Ri | E |
     * |-----------------------------------------------------------| |-----------| N |
     ...
     * |                    POWER                                  | |               |
     * |-----------------------------------------------------------| |---------------|
     * |Esc| F1| F2| F3| F4| F5| F6| F7| F8| F9|F10|F11|F12|Backsp | |NLK| = | / |Ply|
     * |-----------------------------------------------------------| |---------------|
     * |Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|     | |F7 |F8 |F9 |V+ |
     * |-----------------------------------------------------'     | |---------------|
     * |Contro|  A|  S|  D|  F|  G|  H|  J|  K|  L|Fn3|  '|Return  | |F4 |F5 |F6 |V- |
     * |-----------------------------------------------------------| |---------------|
     * |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|   /   |Shift | |F1 |F2 |F3 | E |
     * |-----------------------------------------------------------| |-----------| N |
     * |CAPS|Alt |Gui  |`  |SPC               |BSLS  |LFT|RGT|DN|UP| |   0   | . | T |
     * `-----------------------------------------------------------' `---------------'
     */
